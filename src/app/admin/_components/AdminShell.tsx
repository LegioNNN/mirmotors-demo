          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              ...
              >
                ...
                {item.key === "takip" && overdueCount > 0 && (
                  <span className={`ml-auto rounded-full px-1.5 py-0.5 text-[10px] font-bold ${active ? "bg-white/20 text-white" : "bg-orange-100 text-orange-600"}`}>
                    {overdueCount}
                  </span>
                )}
              </button>
