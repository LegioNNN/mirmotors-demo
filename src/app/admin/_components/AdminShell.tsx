...
import AdminFollowUps from "@/components/ui/AdminFollowUps";
    ...
    <div className="flex min-h-screen bg-[#f4f5f7]">
      ...
      <aside className="hidden lg:flex flex-col w-56 shrink-0 border-r border-gray-200 bg-white">
        ...
        <div className="flex flex-col gap-0.5 px-5 py-4 border-b border-gray-100">
          <img src="/sancaktar-logo-yatay.svg" alt="Sancaktar Otomotiv" className="h-8 w-auto" />
          ...
          <aside className="absolute left-0 top-0 bottom-0 w-56 bg-white shadow-xl flex flex-col">
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
              <div className="flex items-center">
                <img src="/sancaktar-logo-yatay.svg" alt="Sancaktar Otomotiv" className="h-7 w-auto" />
              </div>
        ...
        <header className="sticky top-0 z-30 flex items-center justify-between gap-4 border-b border-gray-200 bg-white px-4 py-3 sm:px-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-400 hidden sm:block">Sancaktar Otomotiv Yönetim Paneli</p>
            </div>
          </div>
