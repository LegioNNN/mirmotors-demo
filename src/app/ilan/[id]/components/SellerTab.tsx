      ...
      <div className="rounded-xl border border-gray-200 bg-white overflow-hidden">
        ...
        <div className="flex items-center gap-4 p-5 border-b border-gray-100">
          ...
          <div className="min-w-0">
            <h3 className="text-base font-black text-[#111827] truncate">Sancaktar Otomotiv</h3>
            <p className="text-sm text-gray-500">İstanbul · 750+ Araçlık Stok</p>
        ...
        <div className="divide-y divide-gray-100">
          <div className="flex items-center gap-3 px-5 py-3.5">
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-[#111827]">Büyükçekmece, İstanbul</p>
            </div>
          </div>
          <div className="flex items-center gap-3 px-5 py-3.5">
            <svg className="h-4 w-4 shrink-0 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
            ...
            <div>
              ...
              <a href="tel:+905019443734" className="text-sm font-semibold text-[#111827] hover:underline">
                0501 944 37 34
              </a>
            </div>
          </div>
          <div className="flex items-center gap-3 px-5 py-3.5">
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-[#111827]">Hft. İçi 09:00–19:00 · Cmt 10:00–17:00</p>
            </div>
          </div>
          <div className="flex items-center gap-3 px-5 py-3.5">
            <svg className="h-4 w-4 shrink-0 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-[#111827]">No: 3407136</p>
            </div>
          </div>
        </div>
